...
const queryTypeOptions = [
  { value: 'Racing Events', label: 'Racing Events' },
  { value: 'Private Events', label: 'Private Events' },
];

const GlobalEventAccessForm = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const pageTitle = 'Global Access Event Form'
    ...
    <div>
      {isSubmitted ? (
        ...
        >
          ...
          <div className="mb-5 text-left">
            <label htmlFor="queryType" className="block mb-2 text-sm font-medium">Type of Query</label>
            <select
              value={queryType}
          ...
          <div className="mb-5 text-left">
            ...
            <input type="text" id="destination" name="destination" className="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Let us know where you’d like to go?" />
          </div>
...
export default GlobalEventAccessForm;
