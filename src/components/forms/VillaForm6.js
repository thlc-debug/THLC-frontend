...
const queryTypeOptions = [
  { value: "Luxury Ocean Villa", label: "Luxury Ocean Villa" },
  { value: "Luxury Hill Villa", label: "Luxury Hill Villa" },
];
  ...
  return (
    <div>
      {isSubmitted ? (
        ...
        >
          <h2 className="text-2xl font-bold mb-2 relative -top-24 bg-black bg-opacity-40 text-white">
            Luxury Villa’s Request
          </h2>
          ...
          <div className="mb-5 text-left">
            ...
            <input
              ...
              id="callBack"
              name="callBack"
              className="w-full p-2.5 shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block"
