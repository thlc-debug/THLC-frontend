...
import PaymentModal from "./transaction/paymentPopUp"; // Import the new component
  ...
  const handleClosePaymentModal = () => setIsPaymentModalOpen(false);
    ...
    return (
        <div className=" bg-white rounded-md h-full flex flex-col">
            {selectedUser ? (
                <TransactionDetails user={selectedUser} onClose={closeTransactionDetails} />
            ) : (
                <>
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div className="flex space-x-3">
                            <button className="px-4 py-2 border text-black font-semibold rounded-md hover:bg-gray-100" onClick={handleOpenPaymentModal}>
                                Create Payment
                            </button>
                            <button
                    ...
                    <div className="flex justify-between items-center mb-4">
                        <div className="bg-gray-100 rounded-md flex border">
                            <button
                                className={`px-6 py-2 font-medium ${activeTab === "all"
                            ...
                            <button
                                className={`px-6 py-2 font-medium ${activeTab === "recent"
                                        ? "bg-white border-b-2 border-black"
                                        : "text-gray-500 bg-white"
                                    }`}
                            ...
                            <button
                                className={`px-6 py-2 font-medium ${activeTab === "pending"
                                        ? "bg-white border-b-2 border-black"
                                        : "text-gray-500 bg-white"
                                    }`}
                        ...
                        <table className="min-w-full bg-white border-b border-gray-200">
                            ...
                            <tbody>
                                {users.map((user, index) => (
                                    <tr key={index} className="border-t cursor-pointer" onClick={() => handleRowClick(user)}>
                                        ...
                                        <td className="px-6 py-4 text-sm">
                                            <span
                                                className={`px-3 py-1 rounded-full text-xs ${user.status === "Success"
