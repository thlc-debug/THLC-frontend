...
const Destinations = () => {
  ...
  const [coverImage, setCoverImage] = useState(null); // Track uploaded cover image
  ...
  return (
    <div className=" bg-white rounded-md h-full flex flex-col">
      ...
      {showUpdateModal && selectedDestination && (
        <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-md w-1/3 shadow-lg">
            <h2 className="text-xl font-bold mb-4">Update Destination</h2>
            ...
            <div className="mb-4">
              ...
              >
                {coverImage ? (
                  ...
                  <Image
                    src={selectedDestination.coverPicture}
                    alt="Cover Picture"
                    className="w-full h-48 object-cover rounded-md"
                  />
                )}
