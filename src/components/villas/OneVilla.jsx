    ...
    <div className="h-full w-full">
      <section className="relative h-[500px] w-auto z-0">
        ...
        <div className="relative flex flex-col items-center justify-center text-center h-full text-white pointer-events-auto">
          <div className="md:text-[70px] text-[40px] text-center font-bold mb-8 mt-[130px]">
            {hotel.name}
          </div>
      ...
      <div className="flex justify-center items-center text-lg mx-5 md:text-2xl my-5 text-center">
        Discover the exquisite details of this hotel and secure your reservation
        today!
      </div>
