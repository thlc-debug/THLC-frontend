...
const images = [
  ...
  { src: '/Four seasons.jpg', link: "/explore", alt: 'Background 3', title: 'Umaid Bhawan Palace', description: 'Experience the Royal Era with our selection of Palaces!' },
  { src: '/heroHome/pexels-h1ghland_fox-396772126-26737937.jpg', link: "/explore", alt: 'Background 4', title: 'The Adare Manor', description: 'The Rich History held within the Castles of Ireland awaits you!' },
  { src: '/home/desertsafari.jpg', alt: 'Background 5', link: "/explore", title: 'Amanera', description: "A Beach, Jungle, and Adventure Paradise!" },
  { src: '/heroimg/Home/pexels-mrwson-4275885.jpg', alt: 'Background 6', link: "/explore", title: 'The Argos', description: 'Witness the Unique Rocks of Cappadocia on a Hot Air balloon!' },
