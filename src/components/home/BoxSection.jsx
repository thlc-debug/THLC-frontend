...
const BoxSection = () => {
  ...
  useEffect(() => {
    ...
    if (selectedCountry) {
      axios.get(`${base_url}/newHotel/cities-by-country/${selectedCountry}`)
        .then(response => {
            ...
            <div className="rounded-3xl sm:px-4 sm:py-4 text-black">
              <div className="flex items-center mb-4">
                <button
                  ...
                  className={`px-2 sm:px-4 text-sm md:text-xl py-2 font-semibold ${tab === 'hotels' ? 'border-b-2 border-black' : ''}`}
                >
                  Hotels
                </button>
                {/* <button
